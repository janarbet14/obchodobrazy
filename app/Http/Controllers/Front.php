...
class Front extends Controller {
    ...
    public function __construct() {
        ...
        $this->products = Product::all(array('id','name', 'title', 'description','unit_price','category_id','sizeX','sizeY','design', 'img_src'));
    }
    ...
    public function products() {
        return view('products', array('title' => 'Products Listing','description' => '','page' => 'products', 'categories' => $this->categories, 'products' => $this->products, 'category' => "Všetko"));
    }
    ...
    public function product_categories($id) {
        ...
        return view('products', array('title' => 'Welcome','description' => '','page' => 'products', 'categories' => $this->categories, 'products' => $products_filtered, 'category' => $category->name));
    }

    public function blog() {
        return view('blog', array('title' => 'Welcome','description' => '','page' => 'blog', 'categories' => $this->categories, 'products' => $this->products));
    }

    public function blog_post($id) {
        return view('blog_post', array('title' => 'Welcome','description' => '','page' => 'blog', 'categories' => $this->categories, 'products' => $this->products));
    }
       ...
       if(Request::isMethod('POST')){
            ...
            switch ($option){
                case "add": {
                    ...
                    Cart::add(array('id' => $product_id, 'name' => $product->name, 'qty' => 1, 'price' => $product->unit_price, 'img_src' => $product->img_src));
                    break;
                }
